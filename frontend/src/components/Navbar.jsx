    ...
    <div className="relative flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
            <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
              {user && <p onClick={()=>navigate('/profile')} className="cursor-pointer hover:text-black">My Profile</p>}
        ...
        <Link to='/cart' className="relative">
          ...
          <p className="absolute right-[0px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]">{getCartCount()}</p>
        </Link>
