...
const NewsLetterBox = () => {
  ...
  return (
    <div className='text-center'>
      ...
      <p className='text-gray-400 mt-3'>Join our community today and enjoy an exclusive 20% discount! Stay updated with the latest offers, products, and special deals delivered straight to your inbox.</p>
